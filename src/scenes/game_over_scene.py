"""Scène de fin de partie : saisie du nom et sauvegarde du score.

Affichée quand le joueur a perdu toutes ses vies. Le joueur tape son nom
(A-Z, 0-9), puis Entrée enregistre le score dans le fichier de highscores et
bascule sur l'écran des meilleurs scores. Échap permet de passer sans
enregistrer (retour au menu).
"""
...
class GameOverScene(Scene):
    ...
    def __init__(self, app, score):
        ...
        self.title_font = BitmapFont(app.sheet, "red", scale=max(2, h // 56))
    ...
    def draw(self, screen, now):
        ...
        self.title_font.draw(screen, "GAME OVER", center=(w // 2, h // 5))
