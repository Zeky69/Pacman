# Les animations des entités (Pac-Man, fantômes) et les thèmes/skins (planche
# par défaut, PNG « secret ») sont définis par données dans `assets/manifest.json`
# et chargés par `views.assets.Assets`. Ce module ne garde que la géométrie de la
# planche `assets/default.png` et les tables de tuiles statiques.
